...
- Install the root-owned system settings in `agent/runtime/gemini-settings.json` so built-in tools use an empty allowlist and extensions, MCP, skills, and YOLO are disabled.
