...
export const serverConfig = {
  ...
  pyannoteProcessTimeoutMs: positiveNumber(process.env.AMF_PYANNOTE_PROCESS_TIMEOUT_MS, 60 * 60_000),
  pyannoteProcessKillGraceMs: positiveNumber(process.env.AMF_PYANNOTE_PROCESS_KILL_GRACE_MS, 2_000),
  pyannoteProcessMaxOutputBytes: positiveNumber(process.env.AMF_PYANNOTE_PROCESS_MAX_OUTPUT_BYTES, 4 * 1024 * 1024),
